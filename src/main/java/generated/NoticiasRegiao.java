 ...
 *       &lt;attribute name="regiao" use="required" type="{http://www.w3.org/2001/XMLSchema}string" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlRootElement(name = "noticiasRegiao")
public class NoticiasRegiao {

    @XmlElement(required = true)
    protected List<Noticia> noticia;
    @XmlAttribute(name = "quantidade", required = true)
    protected int quantidade;
    @XmlAttribute(name = "regiao", required = true)
